...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <img src="<?php echo URL; ?>/assets/image/computador.png" alt=""/> Listar Ocorrências Fechadas-DTI/ <a href="<?php echo URL; ?>controle-ocorrenciadti/cadastrarOcorrenciaDti">Abrir Ocorrência-DTI</a>       
    </div>
</div>
    ...
    <tbody>
        ...
        foreach ($this->Dados as $ocorrencia) {
            ...
            if ($ocorrencia['ocstatusdti'] == 'Pendente') {
                ...
                ?>
                    <td style=" width: 100px;"><?= $ocorrencia['atteccod1dti'] ?></td>
                <?php
                $varcheck1 = "";
                $varcheck2 = "";
                $varcheck3 = "";
                ...
                <td style=" width: 130px;">
                    ...
                    <form id="form_avaliacao">
                        <div class="estrela">
                            ...
                            <input type="hidden" id="ocstatusdti" value="<?= $ocorrencia['ocstatusdti'] ?>">

                            <input type="radio" disabled="true" id="vazio<?php echo $ocorrencia['occoddti'] ?>" name="estrela<?php echo $ocorrencia['occoddti'] ?>" value="" checked="">

                            <label for="estrela_um<?php echo $ocorrencia['occoddti'] ?>"><i class="fa"></i></label>
                            <input type="radio" id="estrela_um<?php echo $ocorrencia['occoddti'] ?>" disabled="true" name="estrela<?php echo $ocorrencia['occoddti'] ?>" value="1" <?php
                            if (!empty($varcheck1)) {
                                echo $varcheck1;
                            }
                            ?>>
                            ...
                            <input type="radio" id="estrela_dois<?php echo $ocorrencia['occoddti'] ?>" disabled="true" name="estrela<?php echo $ocorrencia['occoddti'] ?>" value="2" <?php
                            if (!empty($varcheck2)) {
                                echo $varcheck2;
                            }
                            ?>>
                            ...
                            <input type="radio" id="estrela_tres<?php echo $ocorrencia['occoddti'] ?>" disabled="true" name="estrela<?php echo $ocorrencia['occoddti'] ?>" value="3" <?php
                            if (!empty($varcheck3)) {
                                echo $varcheck3;
                            }
                            ?>>
                            ...
                            <input type="radio" id="estrela_quatro<?php echo $ocorrencia['occoddti'] ?>" disabled="true" name="estrela<?php echo $ocorrencia['occoddti'] ?>" value="4" <?php
                            if (!empty($varcheck4)) {
                                echo $varcheck4;
                            }
                            ?>>
                            ...
                            <input type="radio" id="estrela_cinco<?php echo $ocorrencia['occoddti'] ?>" disabled="true" name="estrela<?php echo $ocorrencia['occoddti'] ?>" value="5" <?php
                                   if (!empty($varcheck5)) {
                                       echo $varcheck5;
                                   }
                                   ?>>

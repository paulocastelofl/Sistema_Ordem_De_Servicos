...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <img src="<?php echo URL; ?>/assets/image/chave.png" alt=""/> Listar Ocorrências Fechadas-Manutenção/ <a href="<?php echo URL; ?>controle-ocorrencia/cadastrarOcorrencia">Abrir Ocorrência-Manutenção</a>       
    </div>
</div>
                ...
                <td style=" width: 130px;">
                    ...
                    <form id="form_avaliacao">
                        <div class="estrela">
                            ...
                            <input type="radio" disabled="true" id="vazio<?php echo $ocorrencia['occod'] ?>" name="estrela<?php echo $ocorrencia['occod'] ?>" value="" checked="">

                            <label for="estrela_um<?php echo $ocorrencia['occod'] ?>"><i class="fa"></i></label>
                            <input type="radio" disabled="true" id="estrela_um<?php echo $ocorrencia['occod'] ?>" name="estrela<?php echo $ocorrencia['occod'] ?>" value="1" <?php
                            if (!empty($varcheck1)) {
                                echo $varcheck1;
                            }
                            ?>>
                            ...
                            <input type="radio" disabled="true" id="estrela_dois<?php echo $ocorrencia['occod'] ?>" name="estrela<?php echo $ocorrencia['occod'] ?>" value="2" <?php
                            if (!empty($varcheck2)) {
                                echo $varcheck2;
                            }
                            ?>>
                            ...
                            <input type="radio" disabled="true" id="estrela_tres<?php echo $ocorrencia['occod'] ?>" name="estrela<?php echo $ocorrencia['occod'] ?>" value="3" <?php
                            if (!empty($varcheck3)) {
                                echo $varcheck3;
                            }
                            ?>>
                            ...
                            <input type="radio" disabled="true" id="estrela_quatro<?php echo $ocorrencia['occod'] ?>" name="estrela<?php echo $ocorrencia['occod'] ?>" value="4" <?php
                            if (!empty($varcheck4)) {
                                echo $varcheck4;
                            }
                            ?>>
                            ...
                            <input type="radio" disabled="true" id="estrela_cinco<?php echo $ocorrencia['occod'] ?>" name="estrela<?php echo $ocorrencia['occod'] ?>" value="5" <?php
                                   if (!empty($varcheck5)) {
                                       echo $varcheck5;
                                   }
                                   ?>>

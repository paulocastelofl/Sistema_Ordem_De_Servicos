...
<div class="panel panel-default">
    <div class="panel-body">
        <div class="form-group">
            <div class="col-sm-4"><i class="fa fa-users" aria-hidden="true"></i> Cadastrar Técnico/ <a href="<?php echo URL; ?>controle-tecnico/index">Listar Técnico</a></div>
...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-horizontal" id="form_tecnico">
            <div class="form-group">
                <label for="tecmatricula" class="col-sm-2 control-label"><span style="color: red">* </span>Matricula:</label>
                <div class="col-sm-4">
                    <input type="text" required="required" class="form-control" id="tecmatricula" placeholder="Digite a matricula">
                </div>
            </div>
            <div class="form-group">
                <label for="tecnome" class="col-sm-2 control-label"><span style="color: red">* </span>Nome:</label>
                <div class="col-sm-8">
                    <input type="text" required="required" class="form-control" id="tecnome" placeholder="Digite nome">
                </div>
            </div>
            <div class="form-group">
